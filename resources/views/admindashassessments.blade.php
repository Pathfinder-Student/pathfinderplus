...
<div class="container">
  <div class="sidebar">
    ...
    <nav class="menu">
      ...
      <a href="{{ route('admindashassessments') }}" class="nav-item active">Assessments</a>
...
<div id="addAssessmentModal" class="modal">
  <div class="modal-content">
    ...
    <form id="assessmentForm" method="POST" action="{{ route('assessments.store') }}">
      @csrf
      ...
      <button type="submit" class="add-btn" style="width: 100%; margin-top: 20px;">Save Assessment</button>
    </form>
  </div>
</div>
...
<!-- Footer -->
<div class="footer">
  Copyright © 2025 BSHS. All rights reserved.
</div>

<script>
  function openAddModal() {
    document.getElementById('assessmentName').value = 'Academic and Personality Skills';
    document.getElementById('description').value = 'Guides strand choice through personality and academic assessment';
